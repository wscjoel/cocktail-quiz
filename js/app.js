...
/* 15 款经典鸡尾酒（AIGC 重绘版，全部 1024×1024 正方形） */
const CLASSICS = [
  { id: 1,  name: '干马天尼',     V: [3, 0, 0, 0, 0, 0, 0], img: '干马天尼_aigc.jpg',     reason: '你这股清醒劲儿，点它准没错。' },
  { id: 2,  name: '尼格罗尼',     V: [0, 2, 0, 2, 0, 0, 0], img: '尼格罗尼_aigc.jpg',     reason: '重口又有气场，刚好接得住你。' },
  { id: 3,  name: '吉姆雷特',     V: [2, 0, 0, 0, 0, 0, 1], img: '吉姆雷特_aigc.jpg',     reason: '干净又锋利，和你一个调性。' },
  { id: 4,  name: '玛格丽特',     V: [2, 0, 0, 0, 2, 0, 0], img: '玛格丽特_aigc.jpg',     reason: '酸甜带劲，跟你一样爱晒太阳。' },
  { id: 5,  name: '梅斯卡尔古典', V: [0, 0, 0, 2, 0, 1, 0], img: '梅斯卡尔古典_aigc.jpg', reason: '带点烟熏故事感，懂的人才懂。' },
  { id: 6,  name: '迈泰',         V: [0, 0, 0, 0, 2, 1, 0], img: '迈泰_aigc.jpg',         reason: '热烈又有层次，配你的野劲儿。' },
  { id: 7,  name: '大都会',       V: [0, 0, 1, 0, 2, 0, 0], img: '大都会_aigc.jpg',       reason: '又飒又精致，气场全在杯里。' },
  { id: 8,  name: '莫斯科骡子',   V: [0, 0, 0, 0, 1, 0, 2], img: '莫斯科骡子_aigc.jpg',   reason: '清爽不端着，跟你一样好相处。' },
  { id: 9,  name: '椰林飘香',     V: [0, 0, 3, 0, 0, 0, 0], img: '椰林飘香_aigc.jpg',     reason: '甜软又松弛，度假感写脸上。' },
  { id: 10, name: '莫吉托',       V: [0, 0, 0, 1, 0, 0, 2], img: '莫吉托_aigc.jpg',       reason: '清新冒泡，少年气满分。' },
  { id: 11, name: '古典',         V: [0, 1, 0, 0, 0, 3, 0], img: '古典_aigc.jpg',         reason: '越品越有味，复古得刚刚好。' },
  { id: 12, name: '曼哈顿',       V: [0, 2, 0, 0, 0, 2, 0], img: '曼哈顿_aigc.jpg',       reason: '浓而不闹，成熟魅力靠它。' },
  { id: 13, name: '威士忌酸',     V: [0, 0, 1, 0, 1, 0, 0], img: '威士忌酸_aigc.jpg',     reason: '酸甜温柔，谁喝都上头。' },
  { id: 14, name: '阿佩罗气泡',   V: [0, 0, 0, 0, 2, 0, 2], img: '阿佩罗气泡_aigc.jpg',   reason: '明亮松弛，自带好天气。' },
  { id: 15, name: '法兰西75',     V: [1, 0, 0, 0, 0, 0, 3], img: '法兰西75_aigc.jpg',     reason: '带气泡的优雅，贵气藏不住。' },
];
